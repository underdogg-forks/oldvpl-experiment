...
namespace Modules\ItemLookups\Controllers;

use App\Http\Controllers\Controller;
use Modules\ItemLookups\Models\ItemLookup;
use Modules\ItemLookups\Requests\ItemLookupRequest;
...
class ItemLookupController extends Controller
{
    ...
    {
        $itemLookups = ItemLookup::sortable(['name' => 'asc'])->with(['taxRate', 'taxRate2'])->keywords(request('search'))->paginate(config('ip.results_per_page'));
