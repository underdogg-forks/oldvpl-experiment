...
use Modules\MailQueue\Support\MailSettings;
...
class SettingController extends Controller
{
    ...
    {
        try {
            Crypt::decrypt(config('ip.mail_password'));
