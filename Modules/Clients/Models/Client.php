...
class Client extends Model
{
    ...
    */
    ...
    {
        return $this->hasMany('Modules\Clients\Models\Contact');
    }
    ...
    {
        return $this->hasOne('Modules\CustomFields\Models\ClientCustom');
    }

    public function expenses()
    {
        return $this->hasMany('Modules\Expenses\Models\Expense');
    }

    public function invoices()
    {
        return $this->hasMany('Modules\Invoices\Models\Invoice');
    }

    public function merchant()
    {
        return $this->hasOne('Modules\Merchant\Models\MerchantClient');
    }
    ...
    {
        return $this->hasMany('Modules\Quotes\Models\Quote');
    }

    public function recurringInvoices()
    {
        return $this->hasMany('Modules\RecurringInvoices\Models\RecurringInvoice');
    }

    public function user()
    {
        return $this->hasOne('Modules\Users\Models\User');
    }
