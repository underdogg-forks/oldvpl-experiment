...
class Quote extends Model
{
    ...
    */
    ...
    {
        return $this->hasOne('Modules\Quotes\Models\QuoteAmount');
    }
    ...
    {
        return $this->hasOne('Modules\CustomFields\Models\QuoteCustom');
    }

    public function group()
    {
        return $this->hasOne('Modules\Groups\Models\Group');
    }

    public function invoice()
    {
        return $this->belongsTo('Modules\Invoices\Models\Invoice');
    }
    ...
    {
        return $this->hasMany('Modules\Quotes\Models\QuoteItem')
