...
class Invoice extends Model
{
    ...
    */
    ...
    {
        return $this->morphMany('Modules\Activity\Models\Activity', 'audit');
    }

    public function amount()
    {
        return $this->hasOne('Modules\Invoices\Models\InvoiceAmount');
    }
    ...
    {
        return $this->belongsTo('Modules\Clients\Models\Client');
    }

    public function clientAttachments()
    {
        $relationship = $this->morphMany('Modules\Attachments\Models\Attachment', 'attachable');
    ...
    {
        return $this->belongsTo('Modules\CompanyProfiles\Models\CompanyProfile');
    }

    public function currency()
    {
        return $this->belongsTo('Modules\Currencies\Models\Currency', 'currency_code', 'code');
    }

    public function custom()
    {
        return $this->hasOne('Modules\CustomFields\Models\InvoiceCustom');
    }

    public function group()
    {
        return $this->belongsTo('Modules\Groups\Models\Group');
    }

    public function items()
    {
        return $this->hasMany('Modules\Invoices\Models\InvoiceItem')
    ...
    {
        return $this->morphMany('Modules\MailQueue\Models\MailQueue', 'mailable');
    }
    ...
    {
        return $this->hasMany('Modules\Payments\Models\Payment');
    }

    public function quote()
    {
        return $this->hasOne('Modules\Quotes\Models\Quote');
    }

    public function transactions()
    {
        return $this->hasMany('Modules\Merchant\Models\InvoiceTransaction');
    }
    ...
    */
    ...
    {
        if ($this->attributes['currency_code'] == config('ip.base_currency')) {
            return false;
        }
