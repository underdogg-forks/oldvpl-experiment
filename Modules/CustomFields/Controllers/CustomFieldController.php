...
use Modules\CustomFields\Requests\CustomFieldStoreRequest;
use Modules\CustomFields\Requests\CustomFieldUpdateRequest;
use Modules\CustomFields\Support\CustomFields;
...
class CustomFieldController extends Controller
{
    ...
    public function index()
    {
        ...
        $customFields = CustomField::sortable(['tbl_name' => 'asc', 'field_label' => 'asc'])->paginate(config('ip.results_per_page'));
