...
namespace Modules\CompanyProfiles\Controllers;

use App\Http\Controllers\Controller;
use Modules\CompanyProfiles\Models\CompanyProfile;
use Modules\CompanyProfiles\Requests\CompanyProfileStoreRequest;
use Modules\CompanyProfiles\Requests\CompanyProfileUpdateRequest;
...
class CompanyProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company_profiles.index')
            ->with('companyProfiles', CompanyProfile::orderBy('company')->paginate(config('ip.results_per_page')));
    }
