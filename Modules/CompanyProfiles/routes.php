...
Route::group(['middleware' => ['web', 'auth.admin'], 'namespace' => 'Modules\CompanyProfiles\Controllers'], function () {
...
Route::get('company_profiles/{id}/logo', ['uses' => 'Modules\CompanyProfiles\Controllers\LogoController@logo', 'as' => 'companyProfiles.logo']);