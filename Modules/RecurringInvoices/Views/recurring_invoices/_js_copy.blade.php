<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#copy_next_date').datepicker({format: '{{ config('ip.datepicker_format') }}', autoclose: true});
    $('#copy_stop_date').datepicker({format: '{{ config('ip.datepicker_format') }}', autoclose: true});
