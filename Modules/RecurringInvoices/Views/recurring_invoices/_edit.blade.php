            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <input type="text" name="summary" value="{{ old('summary', $recurringInvoice->summary) }}" id="summary" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="terms" id="terms" class="form-control" rows="5">{{ old('terms', $recurringInvoice->terms) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="footer" id="footer" class="form-control" rows="5">{{ old('footer', $recurringInvoice->footer) }}</textarea>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="next_date" value="{{ old('next_date', $recurringInvoice->formatted_next_date) }}" id="next_date" class="form-control input-sm">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="stop_date" value="{{ old('stop_date', $recurringInvoice->formatted_stop_date) }}" id="stop_date" class="form-control input-sm">
                    </div>

                    <div class="form-group">
                        <label>@lang('ip.discount')</label>
                        <div class="input-group">
                            <input type="text" name="discount" value="{{ old('discount', $recurringInvoice->formatted_numeric_discount) }}" id="discount" class="form-control input-sm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="exchange_rate" value="{{ old('exchange_rate', $recurringInvoice->exchange_rate) }}" id="exchange_rate" class="form-control input-sm">
