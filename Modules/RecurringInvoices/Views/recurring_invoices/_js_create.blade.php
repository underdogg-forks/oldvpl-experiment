<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#create_next_date').datepicker({format: '{{ config('ip.datepicker_format') }}', autoclose: true});
    $('#create_stop_date').datepicker({format: '{{ config('ip.datepicker_format') }}', autoclose: true});
